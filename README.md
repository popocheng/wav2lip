...
Create a new folder "input_model" and place the downloaded weight files
...
Acknowledgments
----------
Parts of the code structure are inspired by this [Wav2Lip repository](https://github.com/Rudrabha/Wav2Lip). We thank the author for this wonderful code. 
